...
const DoctorCard = ({doctor}) => {
  ...
  <div className='p-3 lg:p-5'>
    ...
    <div className="mt-2 lg:mt-4 flex items-center justify-between">
        <span className='bg-[#CCF0F3] text-irisBlueColor py-1 px-0 lg:py-2 lg:px-6 text-[18px] rounded leading-4 lg:text-[16px] lg:leading-7 font-semibold'>{specialization}</span>
    ...
    <div className="mt-[18px] lg:mt-5 flex items-center justify-between">
        <div>
            <h3 className='text-[16px] leading-7 lg:text-[18px] lg:leading-[30px] text-headingColor  font-semibold'>+{totalPatients} patients</h3>
