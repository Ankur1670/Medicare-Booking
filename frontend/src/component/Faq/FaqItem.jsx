...
const FaqItem = ({item}) => {
  ...
  return (
    <div className='p-3 lg:p-5 rounded-[12px] border border-solid border-[#D9DCE2] mb-5 cursor-pointer'>
      <div className='flex items-center justify-between gap-5' onClick={toggleAccordation}>
      ...
      {isOpen && <div className='mt-4'>
        <p className='text-[14px] leading-6 lg:text-[16px] lg:leading-7 text-[400] text-textColor'>{item.content}</p>
        </div>}
    </div>
  )
}
