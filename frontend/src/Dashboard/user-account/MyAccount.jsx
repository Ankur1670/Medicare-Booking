        ...
        <div className="grid md:grid-cols-3 gap-10">
            <div className="pb-[50px] px-[30px] rounded-md">
                ...
                <div className="text-center mt-4">
                    <h3 className="text-[18px] leading-[30px] text-headingColor font-bold">Jack Paul</h3>
                    <p className='text-textColor text-[15px] left-6 font-medium'>example@gmail.com</p>
                    <p className='text-textColor text-[15px] left-6 font-medium'>Blood Type : <span className='ml-2 text-headingColor text-[22px] leading-8'>o-</span></p>
