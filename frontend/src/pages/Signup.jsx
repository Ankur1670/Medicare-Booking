            ...
            <form onSubmit={submitHandler}>
              <div className="mb-5">
                <input
                  ...
                  className='w-full pr-4 py-3 border-b border-solid border-[#0066ff61] focus:outline-none focus:border-b-primaryColor text-[16px] leading-7 to-headingColor placeholder:text-textColor cursor-pointer' required />
              </div>
              <div className="mb-5">
                <input
                  type="email"
              ...
              <div className="mb-5 flex items-center gap-3">
                ...
                <div className="relative w-[130px] h-[50px]">
                  <input onChange={handleFileInputChange} type="file" name="photo" id="customFile" accept='.jpg,.png' className='absolute top-0 left-0 w-full h-full opacity-0 cursor-pointer' />
              ...
              <div className="mt-7">
                <button disabled={loading} type='submit' className="w-full bg-primaryColor text-white text-[18px] leading-[30px] rounded-lg px-4 py3">
                  {loading ? (
