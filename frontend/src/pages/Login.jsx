...
const Login = () => {
  ...
  const submitHandler = async (event) => {
    ...
    console.log('Form Data being sent:', formData); // Debugging purpose
        ...
        <form className='py-4 md:py-0' onSubmit={submitHandler}>
          <div className="mb-5">
            <input
              ...
              className='w-full py-3 border-b border-solid border-[#0066ff61] focus:outline-none focus:border-b-primaryColor text-[16px] leading-7 to-headingColor placeholder:text-textColor cursor-pointer' 
              required
            />
          </div>
          <div className="mb-5">
